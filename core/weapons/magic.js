...
// Proyectil que persigue al objetivo más cercano.
...
export class MagicWeapon {
  ...
  /** @param {number} delta @param {Array} enemies — no se usa aquí (el target ya está en el proyectil) */
  ...
  /** Limpia proyectiles en vuelo al cambiar de arma */
  destroy() {
