  ...
  _bindEvents() {
    ...
    canvas.addEventListener('touchmove', (e) => {
      ...
      if (e.touches.length === 2) {
        ...
        if (this._lastPinchDist !== null) this._zoom((this._lastPinchDist - dist) * 0.1);
        this._lastPinchDist = dist;
        const cx = (t0.clientX + t1.clientX) / 2;
        const cy = (t0.clientY + t1.clientY) / 2;
        if (this._lastPanX !== null) this._pan(-(cx - this._lastPanX), -(cy - this._lastPanZ));
        this._lastPanX = cx;
        this._lastPanZ = cy;
      } else if (e.touches.length === 1) {
        const t = e.touches[0];
        if (this._lastPanX !== null) this._pan(-(t.clientX - this._lastPanX), -(t.clientY - this._lastPanZ));
